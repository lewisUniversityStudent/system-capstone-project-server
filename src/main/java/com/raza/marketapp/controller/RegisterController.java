...
public class RegisterController {
	...
	public String get_sale_data() {
		...
		output.add("<div class='input-group mb-3'><input class='form-control mr-sm-2' type='text' id='name' placeholder='First Name'></input><input class='form-control mr-sm-2' type='text' id='lastname' placeholder='Last Name'></input><input class='form-control mr-sm-2' type='text' id='username' placeholder='username'></input><input class='form-control mr-sm-2' type='text' id='password' placeholder='password'></input><button class='btn btn-outline-success my-2 my-sm-0'>Login</button></div><br></body></html>");
